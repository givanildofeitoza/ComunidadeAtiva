...
{
    public class BeneficioSocialService : RepositorioGenerico<BeneficioSocial>, IbeneficioSocialService
    {
        public BeneficioSocialService(DbContext BancoDados) : base(BancoDados)
        {
        }
