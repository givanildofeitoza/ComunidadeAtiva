...
{
    public class MoradorNecessidadeEspecialService : RepositorioGenerico<MoradorNecessidadeEspecial>, ImoradorNecessidadeEspecial
    {
        public MoradorNecessidadeEspecialService(DbContext BancoDados) : base(BancoDados)
        {
        }
