...
{
    public class RepositorioBeneficioSocial : RepositorioGenerico<BeneficioSocial>, IbeneficioSocial
    {
        public RepositorioBeneficioSocial(DbContext BancoDados) : base(BancoDados)
        {
        }
